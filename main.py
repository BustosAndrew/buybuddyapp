        ...
        functions=[
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "category": {
                            "type": "string",
                            "description": "The amazon category that the keywords fall under.",
                        },
                        "brand": {
                            "type": "string",
                    ...
                    "required": ["keywords", "category", "brand"],
                },
            }
        ],
        function_call="auto",
...
if response:
    ...
    if message.get("function_call"):
        ...
        function_response = get_amazon_product(
            function_args["keywords"], function_args["category"], function_args["brand"])
        st.session_state.chat_history.append({
            "role": "function",
                    "name": function_name,
